...
//} else {
    // Set params
    $client_id = "133d00a5-2d78-44cf-84bb-ffe7331ac821"; // Client App ID (from Microsoft)
    $client_secret = "P7Hm8x~-cu57P_B14haQ0VVBRTTli.Qx51"; // Client App Secrect (from Microsoft)
    $client_space = "colorcentro.cl"; // Microsoft Domain ID
    $client_redirect = "https://www.campusqroma.com/local/systemscripts/chileSSO.php"; // Where to redirect after authenticated
