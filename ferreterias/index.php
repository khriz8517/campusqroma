...
if (!empty($SESSION->loginerrormsg)) {
    ...
    redirect(new moodle_url('/ferreterias/index.php'));
}
...
if (isloggedin() and !isguestuser()) {
    ...
    $logout = new single_button(new moodle_url('/ferreterias/logout.php', array('sesskey'=>sesskey(),'loginpage'=>1)), get_string('logout'), 'post');
    ...
    echo $OUTPUT->render($loginform, false, true);
}
